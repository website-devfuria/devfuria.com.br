...
A primeira coisa que precisamos saber sobre o fatiamento de sequências é um pouco óbvio mas vale reforçar:
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>de <code>a</code> (inclusive) até <code>b</code>(exclusive)</td>
        </tr>
        <tr>
            <td><code>s[a:]</code></td>
            <td>a partir de <code>a</code>(inclusive)</td>
        </tr>
        <tr>
            <td><code>s[:b]</code></td>
            <td>até <code>b</code>(exclusive)</td>
        </tr>
        <tr>
            <td><code>s[:]</code></td>
            <td>total de <code>s</code></td>
        </tr>
        <tr>
            <td><code>s[a:b:n]</code></td>
            <td>de <code>n</code> em <code>n</code>itens</td>
        </tr>
    </tbody>
</table>
