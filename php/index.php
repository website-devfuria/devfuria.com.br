            ...
            <div class="row">
                <div class="span10 offset1">
                    <div class="furia-tree">
                        <div id="treecontrol">
                            <a href="#" title="Collapse the entire tree below"><img alt="-" src="../furia/treeview/images/minus.gif">Contrair todos</a>
                            <a href="#" title="Expand the entire tree below"><img alt="+" src="../furia/treeview/images/plus.gif">Expandir todos</a>
                        </div>
