...
$url = "/php/basico/recebendo-dados-via-get-post/";
?>
<!DOCTYPE html>
<html lang="pt">
    <head>
        <?php
        $conteudo->head->setTitle('Recebendo dados via GET e POST');
        $conteudo->head->setDescription('Matéria de php sobre as variáveis globais $_GET e $_POST.');
