...
<html lang="pt">
    ...
    <body>
        <a href="<?php echo ROOT_PATH ?>" class="btn-home">Home</a>
        ...
        <div class="col-md-10" role="main">
            ...
            <div id="2013" class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <a href="<?php echo LINKS_PATH . "/core/imagens/port-ah-08.png" ?>" class="thumbnail">
                        ...
                        <div class="col-md-7">
                            <div class="row">
                                <div class="col-md-4 hidden-xs">
                                    <a href="<?php echo LINKS_PATH . "/core/imagens/port-ah-06.png" ?>" class="thumbnail">
                                        <img src="<?php echo LINKS_PATH . "/core/imagens/port-ah-06.png" ?>" />
                                    </a>
                                </div>
                                <div class="col-md-4 hidden-xs">
                                    <a href="<?php echo LINKS_PATH . "/core/imagens/port-ah-01.png" ?>" class="thumbnail">
                            ...
                            <div class="row">
                                <div class="col-md-8 hidden-xs">
                                    <a href="<?php echo LINKS_PATH . "/core/imagens/port-ah-05.png" ?>" class="thumbnail">
                            ...
                            <div class="row">
                                <div class="col-md-6 hidden-xs">
                                    <a href="<?php echo LINKS_PATH . "/core/imagens/port-ah-04.png" ?>" class="thumbnail">
                                        <img src="<?php echo LINKS_PATH . "/core/imagens/port-ah-04.png" ?>" />
                                    </a>
                                </div>
                                <div class="col-md-6 hidden-xs">
                                    <a href="<?php echo LINKS_PATH . "/core/imagens/port-ah-07.png" ?>" class="thumbnail">
            ...
            <div id="2012" class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <a href="<?php echo LINKS_PATH . "/core/imagens/port-devfuria-01.png" ?>" class="thumbnail">
                                <img src="<?php echo LINKS_PATH . "/core/imagens/port-devfuria-01.png" ?>" />
                            </a>
                        </div>
                        <div class="col-md-offset-1 col-md-3 hidden-xs">
                            <a href="<?php echo LINKS_PATH . "/core/imagens/port-devfuria-03.png" ?>" class="thumbnail">
                                <img src="<?php echo LINKS_PATH . "/core/imagens/port-devfuria-03.png" ?>" />
                            </a>
                        </div>
                        <div class="col-md-offset-1 col-md-3 hidden-xs">
                            <a href="<?php echo LINKS_PATH . "/core/imagens/port-devfuria-02.png" ?>" class="thumbnail">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-offset-1 col-md-6">
                            <a href="<?php echo LINKS_PATH . "/core/imagens/port-seg-01.png" ?>" class="thumbnail">
                                <img src="<?php echo LINKS_PATH . "/core/imagens/port-seg-01.png" ?>" />
                            </a>
                        </div>
                    </div>
                    <div class="col-md-offset-1 col-md-3 hidden-xs">
                        <a href="<?php echo LINKS_PATH . "/core/imagens/port-seg-02.png" ?>" class="thumbnail">
                            <img src="<?php echo LINKS_PATH . "/core/imagens/port-seg-02.png" ?>" />
                        </a>
                    </div>
                    <div class="row">
                        <div class="col-md-offset-1 col-md-6 hidden-xs">
                            <a href="<?php echo LINKS_PATH . "/core/imagens/port-seg-03.png" ?>" class="thumbnail">
            ...
            <div id="2010" class="panel panel-warning">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <a href="<?php echo LINKS_PATH . "/core/imagens/port-acs-01.png" ?>" class="thumbnail">
                    ...
                    <div class="row">
                        <div class="col-md-offset-2 col-md-4 hidden-xs">
                            <a href="<?php echo LINKS_PATH . "/core/imagens/port-acs-02.png" ?>" class="thumbnail">
                                <img src="<?php echo LINKS_PATH . "/core/imagens/port-acs-02.png" ?>" />
                            </a>
                            <p style="text-align: center">Tela principal (HOME)</p>
                        </div>
                        <div class="col-md-offset-1 col-md-3 hidden-xs">
                            <a href="<?php echo LINKS_PATH . "/core/imagens/port-acs-04.png" ?>" class="thumbnail">
                    ...
                    <div class="row">
                        <div class="col-md-offset-2 col-md-3 hidden-xs">
                            <a href="<?php echo LINKS_PATH . "/core/imagens/port-acs-03.png" ?>" class="thumbnail">
                                <img src="<?php echo LINKS_PATH . "/core/imagens/port-acs-03.png" ?>" />
                            </a>
                        </div>
                        <div class="col-md-offset-2 col-md-3 hidden-xs">
                            <a href="<?php echo LINKS_PATH . "/core/imagens/port-acs-05.png" ?>" class="thumbnail">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 hidden-xs">
                            <a href="<?php echo LINKS_PATH . "/core/imagens/port-dom-01.png" ?>" class="thumbnail">
                                <img src="<?php echo LINKS_PATH . "/core/imagens/port-dom-01.png" ?>" />
                            </a>
                        </div>
                        <div class="col-md-offset-2 col-md-3">
                            <a href="<?php echo LINKS_PATH . "/core/imagens/port-dom-02.png" ?>" class="thumbnail">
                    ...
                    <div class="row">
                        <div class="col-md-3 hidden-xs">
                            <a href="<?php echo LINKS_PATH . "/core/imagens/port-dom-03.png" ?>" class="thumbnail">
                                <img src="<?php echo LINKS_PATH . "/core/imagens/port-dom-03.png" ?>" />
                            </a>
                        </div>
                        <div class="col-md-offset-1 col-md-3 hidden-xs">
                            <a href="<?php echo LINKS_PATH . "/core/imagens/port-dom-05.png" ?>" class="thumbnail">
                                <img src="<?php echo LINKS_PATH . "/core/imagens/port-dom-05.png" ?>" />
                            </a>
                        </div>
                        <div class="col-md-offset-1 col-md-3 hidden-xs">
                            <a href="<?php echo LINKS_PATH . "/core/imagens/port-dom-04.png" ?>" class="thumbnail">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-offset-2 col-md-4">
                            <a href="<?php echo LINKS_PATH . "/core/imagens/port-vw-01.png" ?>" class="thumbnail">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <a href="<?php echo LINKS_PATH . "/core/imagens/port-vw-02.png" ?>" class="thumbnail">
                                <img src="<?php echo LINKS_PATH . "/core/imagens/port-vw-02.png" ?>" />
                            </a>
                        </div>
                        <div class="col-md-3 hidden-xs">
                            <a href="<?php echo LINKS_PATH . "/core/imagens/port-vw-03.png" ?>" class="thumbnail">
                                <img src="<?php echo LINKS_PATH . "/core/imagens/port-vw-03.png" ?>" />
                            </a>
                        </div>
                        <div class="col-md-3 hidden-xs">
                            <a href="<?php echo LINKS_PATH . "/core/imagens/port-vw-04.png" ?>" class="thumbnail">
                                <img src="<?php echo LINKS_PATH . "/core/imagens/port-vw-04.png" ?>" />
                            </a>
                        </div>
                        <div class="col-md-3 hidden-xs">
                            <a href="<?php echo LINKS_PATH . "/core/imagens/port-vw-05.png" ?>" class="thumbnail">
