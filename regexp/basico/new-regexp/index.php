...
<html lang="pt">
    <head>
        <?php
        $conteudo->head->setTitle('Compilando Expressões Regulares');
        $conteudo->head->setDescription('Essa matéria, curtinha diga-se de passagem, mostra como compilar uma ER.');
        $conteudo->head->setkeywords('compilar er, compilar expressões regulares');
