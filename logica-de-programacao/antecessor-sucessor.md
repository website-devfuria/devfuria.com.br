...
title:       Antecessor e sucessor<br />de um número qualquer
description: Exercício de lógica de programação resolvido<br />onde o objetivo é calcular o sucessor e o antecessor<br />de um número qualquer.
