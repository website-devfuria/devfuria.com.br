...
[Fonte da imagem](http://vidadeprogramador.com.br/2011/08/19/erro-nao-documentado/)


Superficialmente, debugar é sinônimo de teste, mas em essência são coisas totalmente diferentes. "Testes" é uma palavra
com escopo ampliado, veja o que a [Wikipedia](http://pt.wikipedia.org/wiki/Teste_de_software) tem a nos
dizer sobre testes.
...
Quem desenvolve em JavaScript e utiliza o [Firefox](https://www.mozilla.org/pt-BR/firefox/new/) para ver
o resultado pode contar com o [Firebug](https://getfirebug.com/) (já comentei um monte de vez sobre esse
...
[addons.mozilla.org](https://addons.mozilla.org/pt-br/firefox/addon/firebug).
