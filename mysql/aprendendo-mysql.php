...
<html lang="pt">
    <head>
        <?php
        $core->head->setTitle('aprendendo mysql');
        $core->head->setDescription('Aprenda mysql de uma forma que você nunca viu. Material altamente organizado e de qualidade impecável.');
        $core->head->setkeywords("aprendendo mysql; matérias sobre mysql;");
        $core->head->setAuthor();
