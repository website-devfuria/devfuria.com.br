...
(6, '/html-css/basico/formularios-web/', 'Formulários Web e seus controles ', 'Formulários Web e seus controles', NULL, 'Formulários Web e seus controles', 'Matéria demonstrando os controles básicos de HTML: input, select, textarea, etc...', 'html-css', 'curso', 'on', '2014-01-06', '2014-01-06', ''),
(2, '/html-css/basico/html-intro/', 'Primeiro contato com HTML', 'Primeiro contato com HTML', NULL, 'Tags básicas de HTML', 'Aprendendo as tags básicas de HTML (âncoras, listas, tabelas, formulários, div e span)', 'html-css', 'curso', 'on', '2013-01-23', '2013-12-13', ''),
(1, '/html-css/basico/onde-tudo-comecou/', 'Onde tudo começou', 'Onde tudo começou', NULL, 'Introdução ao HTML e ao CSS', 'Aprenda sobre: tags básicas de HTML, corpo de HTML, CSS, seletores, propriedades e ferramentas que ajudam no desenvolvimento', 'html-css', 'curso', 'on', '2013-01-23', '2014-02-14', ''),
(5, '/html-css/basico/primeiro-html/', 'Criando nosso primeiro HTML [com vídeo]', 'Criando nosso primeiro HTML', NULL, 'Crie seu primeiro HTML', 'Aprenda a cirar um HTML de ótima qualidade, usaremos como base o HTML do site www.csszengarden.com', 'html-css', 'curso', 'on', '2013-04-12', '2013-04-12', ''),
(9, '/js/basico/checkbox-checked/', 'Manipulando check boxes', 'Manipulando check boxes com JavaScript', NULL, 'Javascript - Ler valores dos checkbox que estiverem checkados', 'Controle de checkbox em javascript, verificar se os CheckBox foram marcados.', 'js', 'curso', 'on', '2014-02-21', '2014-02-21', ''),
(7, '/js/basico/code-lampadas-refatorando/', 'Code - A Lâmpada (refatorando)', 'Code - A lâmpada (refatorando)', NULL, 'Refatorando o código da matéria "Code - A lâmpada"', 'Matéria onde mostramos a prática de organizar e refatorar o código JS.', 'js', 'curso', 'on', '2013-07-08', '2014-02-07', ''),
(4, '/js/basico/code-lampadas/', 'Code - A Lâmpada', 'Code - A lâmpada', NULL, 'Aprenda javascript com este exemplo de código: a lâmpada', 'Aprendendo código escrito em javascript que ascende e apaga uma lâmpa! Princípio de animações com JS.', 'js', 'curso', 'on', '2013-04-10', '2013-04-30', ''),
(3, '/js/basico/debugando/', 'Debugando (depurando) [com vídeo]', 'Debugando (depurando) JS', NULL, 'Debugando com Javascript', 'Aprenda a debugar seus scripts em Javascript, este é o primeiro passo na depurarção de código.', 'js', 'curso', 'on', '2013-04-10', '2013-04-30', ''),
(1, '/js/basico/intro/', 'Introdução', 'Introdução ao Javascript', NULL, 'Javascript: Introdução a linguagem de programação Javascript', 'Uma introdução ao Javascript. Acompanha 2 script para quebrar o gelo', 'js', 'curso', 'on', '2012-10-08', '2012-11-08', ''),
(5, '/js/basico/oop-primeiro-degrau/', 'OOP - primeiro degrau', 'OOP - primeiro degrau', NULL, 'OOP', 'Introduziremos conceito intuitivo de programação orientadação a objeto, propriedades e métodos.', 'js', 'curso', 'on', '2013-07-08', '2014-02-07', ''),
(2, '/js/basico/preparando-o-terreno/', 'Preparando o terreno', 'Preparando o terreno', NULL, 'Antes de programar em JS veja esta matéria', 'Veremos Separações de Interesses (separation of concerns), onde colocar o JS e uma rápida pincelada em OOP, FIREBUG e a questão da segurança!.', 'js', 'curso', 'on', '2012-10-08', '2012-11-08', ''),
(6, '/js/basico/refatoracao-codigo-limpo/', 'Refatoração e código limpo', 'Refatoração e código limpo', NULL, 'Refatoração e código limpo', 'Dandos os primeiros passos na refatoração de código. Aprenda a codificar de forma mais coesa.', 'js', 'curso', 'on', '2013-07-08', '2014-02-07', ''),
(8, '/js/basico/textbox-password-textarea/', 'Descobrindo os controles text, password e textarea', 'Descobrindo os controles text, password e textarea', NULL, 'Javascript - input type text input type password textarea', 'Aprendendo como os campos textbox, password e textarea funcionam com o Javascript.', 'js', 'curso', 'on', '2014-02-21', '2014-02-21', ''),
(9, '/logica-de-programacao/basico/code-triangulo-tdd/', 'Code - Triângulo + TDD', 'Code - Triângulo com TDD', NULL, 'TDD passo a passo', 'Matéria que demonstra a técnica do TDD. Lógica de programação alida ao TDD.', 'logica', 'curso', 'on', '2014-01-30', '2014-01-30', ''),
(6, '/logica-de-programacao/basico/code-triangulo/', 'Code - Triângulo', 'Code - Triângulo', NULL, 'Exemplo de código que utiliza funções', 'Matéria introdutória ilustrando a sintaxe básica do último exercício de lógica: é triângulo', 'logica', 'curso', 'on', '2014-01-09', '2014-01-09', ''),
(4, '/logica-de-programacao/basico/exercicios-expressoes-condicionais/', 'Exercícios de lógica de programação (expressões condicionais)', '5 Exercícios de lógica de programação', NULL, 'Exercícios de lógica de programação envolvendo expressões condicionais', 'Exercícos resolvidos de lógica de programação (sobre expressões condicionais)', 'logica', 'curso', 'on', '2013-12-20', '2013-12-20', ''),
(2, '/logica-de-programacao/basico/exercicios-operadores-atribuicao/', 'Exercícios de lógica de programação (operadores de atribuição)', '10 Exercícios de lógica de programação ', NULL, 'Exercícios de lógica de programação envolvendo operadores de atribuição', 'Exercícos de lógica de programação com respostas (sobre operadores de atribuição)', 'logica', 'curso', 'on', '2013-06-05', '2013-08-11', ''),
(5, '/logica-de-programacao/basico/funcoes-procedimentos/', 'Funções', 'Funções', NULL, 'Apendendo o básico sobre funções', 'Como criar e utilizar funcções em PHP e Javascript, máteria de nível básico introduzindo uso de funções', 'logica', 'curso', 'on', '2014-01-09', '2014-01-09', ''),
(3, '/logica-de-programacao/basico/if-else/', 'Expressões Condicionais (if-else)', 'Expressões Condicionais', NULL, 'Conceitos e exemplos do if-else para PHP', 'Aprenda sobre a tomada de decisões no PHP com as estruturas de controle if, else e elseif.', 'logica', 'curso', 'on', '2013-12-20', '2013-12-20', ''),
(1, '/logica-de-programacao/basico/intro/', 'Introdução a Lógica de Progamação', 'Introdução a Lógica de Programação', NULL, 'Matéria introdutória sobre Lógica de Programação', 'Matéria que introduz o curso de Lógica de Programação aqui no devfuria.com.br', 'logica', 'curso', 'on', '2013-12-20', '2012-07-25', ''),
(7, '/logica-de-programacao/basico/oop-programacao-orientada-a-objetos/', 'Vamos de OOP?', 'Vamos de OOP?', NULL, 'Matéria introdutória sobre OOP e Lógica de Programação', 'Matéria que introduz o conceito e prática de OOP para que possamos utilizar a lógica aliada a orientação a objetos. ', 'logica', 'curso', 'on', '2014-01-16', '2014-01-16', ''),
(8, '/logica-de-programacao/basico/tdd-test-driven-development/', 'Vamos de TDD?', 'Vamos de TDD?', NULL, 'Matéria introdutória sobre TDD e Lógica de Programação', 'Matéria que introduz o conceito e prática de TDD', 'logica', 'curso', 'on', '2013-12-19', '2013-12-19', ''),
(3, '/mysql-sql/basico/criando-base-tabela/', 'Criando e populando uma tabela', 'Criando e populando uma tabela', NULL, 'Matéria onde criaremos nossa primeira tabela no MySql', 'Aprenda a criar uma tabela no MySql e também veja um pouco sobre os comandos TRUNCATE, DROP TABLE e LOAD LOCAL DATA', 'mysql', 'curso', 'on', '2014-01-10', '2014-01-10', ''),
(4, '/mysql-sql/basico/crud/', 'Entendendo o que é CRUD', 'Entendendo o que é CRUD', NULL, 'CRUD SQL', 'Aprenda a fazer um CRUD (create, read, update, delete) com os comandos SQL', 'mysql', 'curso', 'on', '2014-01-27', '2014-01-27', ''),
...
(2, '/php/basico/instalando-o-ambiente/', 'Instalando o ambiente no estilo NEXT, NEXT, NEXT', 'Instalando o Ambiente no estilo NEXT, NEXT, NEXT.', NULL, 'Levantando um ambiente de programação (PHP)', 'Aprenda a levantar seu ambiente de programação de forma descomplicada e sem sustos', 'php', 'curso', 'on', '2012-06-05', '2012-09-11', ''),
...
(4, '/regexp/basico/pattern-test/', 'pattern.test() ', 'pattern.test()', NULL, 'pattern.test()', 'Dissecando a função pattern.test() do JS, ele retorna true se  encontrar uma correspondência, caso contrário, retorna false.', 'regexp', 'curso', 'on', '2013-07-22', '2013-07-22', ''),
(7, '/regexp/basico/ponto/', 'ponto', 'O ponto .', NULL, '. (ponto) nas expressões regulares', 'Matéria que traz várias imagens (todas de autoria do Aurélio Marinho) ilustrando o uso do ', 'regexp', 'curso', 'on', '2013-07-22', '2013-07-22', ''),
(2, '/regexp/basico/preg-match/', 'preg_match()', 'preg&#95;match()', NULL, 'preg_match()', 'Dissecando a função preg_match() do PHP, método para expressão regular segundo o PCRE', 'regexp', 'curso', 'on', '2013-07-22', '2013-07-22', ''),
