...
<html lang="pt">
    ...
    <body>
        ...
        <div class="bs-header" id="content">
            <div class="container">
                <h1>10 Exercícios de lógica de programação </h1>
                <p>...envolvendo operadores de atribuição</p>
            </div>
        </div>
        ...
        <div class="bs-old-docs">
            <div class="container">
                Flávio Micheletti, atualizado em <span class="label label-success">11/08/2013</span>, escrito em <span class="label label-info">05/06/2012</span>.
            </div>
        </div>
